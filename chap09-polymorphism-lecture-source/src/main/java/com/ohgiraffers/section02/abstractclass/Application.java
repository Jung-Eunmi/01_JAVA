...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        /* title. 추상클래스와 추상메소드에 대해 이해할 수 있다. */

        /* comment.
        *   추상클래스와 추상메소드
        *   추상메소드를 0개 이상 가지고 있는 클래스를 추상클래스라고 한다.
        *   추상클래스는 클래스 선언부에 abstract 라고 명시 해야 한다.
        *   추상클래스는 클래스인 척 하는 녀석이기 때문에 직접적으로 인스턴스를 생성할 수 없다.
        *   그렇기 때문에 추상클래스를 사용하기 위해서는
        *   상속 받은 자식클래스를 이용해서 인스턴스를 생성해야 한다.
        * */
...
//        Product product = new Product();
        ...
        /* index 3. 동적 바인딩을 통해 자료형은 Product 이지만, SmartPhone 의 메소드가 호출됨 */
        product.abstMethod();
        ...
        *   따라서 여러 클래스를 그룹화하여 필수 기능을 정의해 강제성을 부여하여
