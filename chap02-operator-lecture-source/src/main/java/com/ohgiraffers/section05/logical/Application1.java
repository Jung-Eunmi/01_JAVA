...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        /* comment.
        *   1. 논리 연결 연산자
        *    - 두 개의 피연산자를 가지는 이항 연산자이며, 두 개의 논리 식을 판단하여 참과 거짓을 판단해준다.
        *       1-1. &&(논리 AND) 연산자
        *        - 두 개의 논리식 모두 참 일 경우 참을 반환 , 둘 중 하나라도 거짓이면 거짓이다.
        *       1-2. ||(논리 OR) 연산자
        *        - 두 개의 논리식 둘 중 하나라도 참 일 경우 참을 반환 , 둘 다 거짓이면 거짓이다.
        *   2. 논리 부정 연산자
        *    - 피연산자가 하나인 단항 연산자
        *       2-1. !(논리 NOT) 연산자
        ...
        * */
        ...
        System.out.println("true 와 true 의 논리 and 연산 : " + (true && false));
        System.out.println("true 와 true 의 논리 and 연산 : " + (false && true));
        System.out.println("true 와 true 의 논리 and 연산 : " + (false && false));

        System.out.println("===================================================");

        System.out.println("true 와 true 의 논리 or 연산 : " + (true || true));
        System.out.println("true 와 true 의 논리 or 연산 : " + (true || false));
        System.out.println("true 와 true 의 논리 or 연산 : " + (false || true));
        System.out.println("true 와 true 의 논리 or 연산 : " + (false || false));

        System.out.println("===================================================");

        System.out.println("true 의 논리 not 연산 : " + (!true));

        /* index 1. 논리식에 논리연산자 활용해보기 */
