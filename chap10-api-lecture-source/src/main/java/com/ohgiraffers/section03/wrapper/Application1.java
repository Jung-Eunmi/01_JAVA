...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        *   8가지의 기본 타입 데이터를 인스턴스화 할 수 있도록 하는 클래스를 Wrapper 클래스 라고 한다.
        ...
        * */
        ...
        Integer boxingNumber = new Integer(intValue);   // 인스턴스화 - 생성자 이용
        Integer boxingNumber2 = Integer.valueOf(intValue); // 인스턴스화 - static 메소드 이용
