...
public class Application2 {
    ...
    public static void main(String[] args) {
         ...
         *   2. 변수에 값을 대입한다.(값 대입 및 초기화 (초기화: 초기에 값을 설정한다))
         *   3. 변수를 사용한다.
         * */
        ...
        /* 필기.
             ...
             Compiler ('Compiler' : 번역기)와 약속한 키워드이다.
        ...
        /* 필기. 논리값을 취급하는 자료형은 한 가지가 있다. */
        boolean isTrue; // 1byte

        /*필기. 이상 8가지를 기본자료형(Primary Type) 이라고 한다. */

        /* 목차1-1-4. 문자열을 취급하는 자료형 */
        String str; // 4byte 주소는 엄밀히 따지면 5byte 정수형으로 저장된다.

        //메모리에 값을 저장하기 위한 공간!만 생성을 한 상태이다.

        /* 목차2. 변수에 값을 대입한다. (값 대입 및 초기화) */
        // 우리는 =(대입 연산자) 를 이용하여 값을 저장할 수 있다.

        /* 목차2-1. 정수를 취급하는 자료형에 값 대입해보기. */
        bnum = 1;
        snum = 2;
        inum = 4;
        lnum = 8L; // 소문자 l 을 써도 되지만 , 숫자 1과 혼선 여부가 있어 대문자를 씀

        /* 목차2-2. 실수를 취급하는 자료형에 값 대입해보기. */
        fnum = 4.0f; // 대문자 F 를 써도 되지만 , 소문자를 쓰는 것이 일반적이다.
        dnum = 8.0;

        /* 목차2-2. 문자를 취급하는 자료형에 값 대입해보기. */
        ch = 'a'; // 문자는 '' 홀따옴표 사용!!
        ch = 97; // 문자는 내부적으로 숫자로 저장이 되어있다. (section1 참고.)
