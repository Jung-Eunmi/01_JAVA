...
public class A_for {
    ...
    public void testSimpleForStatement() {
        ...
        * */
        ...
        /* index 1. 1 부터 10 까지 1 씩 증가시키면서 i 값을 출력하는 반복문 */
        // 초기식 : int i = 1;
        // 조건식 : i <= 10;
        // 증감식 : i++
        for(int i = 1; i <= 10; i++) {
    ...
    public void testForExample1() {
        ...
        /* index 2. 10 명의 학생 이름을 입력 받아 이름을 출력해보자. */
        ...
        *   2. 학생의 이름 뿐 아니라, 성적이나 이름을 입력하는 기능도 추가를 해야 한다면? (유지 보수성 상승)
        * */
    ...
    public void testForExample4(){
        ...
        * */
        ...
        //합산 결과를 담을 수 있는 변수 만들어두기
        int sum = 0;

        //만약 첫 번째 입력한 정수가 더 큰 경우
        if(first>second){
            for(int i = second; i<=first; i++){
                sum += i;
            }
        //만약 두 번째 입력한 정수가 더 큰 경우
        }else {
    ...
    public void printSimpleGugudan(){
        ...
        /* comment.
        *   스캐너로 2~9 사이의 구구단을 입력받아 2~9 사이인 경우 구구단을 출력하고,
