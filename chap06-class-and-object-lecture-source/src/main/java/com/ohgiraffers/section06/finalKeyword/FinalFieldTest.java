...
//    private static final int STATIC_NUM;    // 0 이라는 기본값이 초기화 되기 때문에 오류 발생
    private static final double PI = 3.14;    // 생성과 동시에 값을 넣어줘야함
    ...
    *   기본값으로 초기화 돈 후 값을 변경하지 못 하기 때문에 에러가 발생한다.
    * */
    private static final double STATIC_DOUBLE;

//    public FinalFieldTest(double staticDouble){
//        FinalFieldTest.STATIC.DOUBLE = staticDouble;
