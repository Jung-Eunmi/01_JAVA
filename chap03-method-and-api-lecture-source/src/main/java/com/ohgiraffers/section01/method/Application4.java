...
public class Application4 {
    ...
    public static void main(String[] args) {
        ...
        app4.testArgsMethod("정은미",29,'여');
//        app4.testArgsMethod(29,"정은미",'여'); // 값의 갯수는 맞지만, 순서가 다르게 전달되면 안된다.
//                                                 (컴퓨터는 왼쪽에서 오른쪽으로 읽기때문이다)
    ...
    public void testArgsMethod(String name, int age, final char gender) {
        ...
        *   매개변수 역시 상수의 의미를 가지는 final 키워드를 사용할 수 있다.(지역변수에 final 키워드를 붙이는 것과 동일하다.)
        * */
