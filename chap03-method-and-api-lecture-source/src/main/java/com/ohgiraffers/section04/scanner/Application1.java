...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        // Scanner 는 학습때문에 배우는 거라서 너무 깊이 파지 않아도 됨!!(현업에서 안씀)
        /* index 1. Scanner 클래스 사용 할 준비 */
        Scanner sc = new Scanner(System.in);

        /* comment. ln의 의미는 개행(줄바꿈,enter 키)의 의미이다. */
        System.out.println("안녕");
        System.out.print("나는");
        System.out.println("정은미야");
        ...
        *   따라서 문자열로 입력을 받은 후, 입력 받은 문자에서 원하는 순번의 문자를 분리해서 사용을 해야 한다.
        *   chatAt(int index) 를 사용해서 문자열을 분리 할 수 있다.
        *   정수형으로 값을 넘기게 되면 문자열에서 해당하는 번호를 가진 문자를 반환해주는 기능을 한다.
        *   index 숫자 체계는 컴퓨터에서 정말 많이 쓰인다.
        *   보통 숫자를 1 부터 세지만, index 숫자 체계 특징은 0 부터 숫자가 시작한다.
        * */
        sc.nextLine();
