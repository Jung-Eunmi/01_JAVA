...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        /* 필기.
            -상수란?
            변수가 메모리에 변경될 수 있는 값을 저장하기 위한 공간 이라고 한다면,
            상수는 반대되는 개념이다.
            변하지 않는 값(고정 된 값)을 저장하기 위한 메모리 상의 공간을 상수 라고 한다.
        ...
        /* 목차1. 상수 선언 */
        final int AGE; // 상수는 변수와의 차별성을 띄기 위해서 대문자로 상수명을 짓는다.
        
        /* 목차2. 값 초기화(대입) */
        AGE = 20;
//        AGE = 30; 한 번 초기화 한 이후 값을 재 대입하는 것은 불가능하다.
        
        /* 목차3. 필요한 위치에서 호출해서 사용 */
