...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        *           호출하여 부모 클래스의 인스턴스로 같이 생성하게 된다.
        *           이 때 생성한 부모 클래스의 인스턴스 주소를 보관하는 래퍼런스 변수이다.
        ...
        * */
        ...
        Product product2 = new Product("S-1234","삼송","갠역시폴드6",2220000, LocalDateTime.now());
        ...
        Computer computer3 = new Computer("S-1234","삼송","갠역시폴드6",2220000, LocalDateTime.now(),
                                          "인텔",512,16,"윈도우");
