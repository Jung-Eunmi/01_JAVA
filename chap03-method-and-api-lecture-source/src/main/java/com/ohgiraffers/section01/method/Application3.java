...
//        app3.testMethod(40);
//        app3.testMethod("40");  // 매개변수 공간은 int 형인데, 인자를 String 으로 보내서 오류
//        app3.testMethod(20,30,40);  // 매개변수의 준비 된 공간이 1개인데, 전달인자를 3개 보냈기 때문에 오류
//        app3.testMethod(); // 매개변수는 선언되어 있는데, 전달인자로 값을 전달하지 않았기 때문에 오류
