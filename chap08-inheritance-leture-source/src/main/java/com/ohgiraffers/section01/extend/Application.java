...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        *     1-1. 재사용 시 생산성을 크게 향상 시킬 수 있다.(새롭게 작성 안해도 됨)
        *     1-2. 공통적으로 사용하는 코드가 부모클래스에 존재하게 되면
        *          수정사항이 생길 시, 부모클래스만 수정을 해도 전체적으로 사용 가능하다.(유지보수성 증가)
        *   2. 클래스 간의 계층 관계가 생기며 다형성 문법의 토대가 된다.
        *   <상속의 단점>
        *   1. 부모클래스의 기능을 추가/변경할 시 자식클래스가 정상적으로 동작하는 지 예측 어렵다.
        *      상속 구조가 복잡해질수록 그 영향에 대한 예측이 힘들어지며
        *      이러한 복잡한 구조는 오히려 유지보수성을 악화시킬 수 있다.
        *   2. 부모클래스의 변경이 쉽지 않다.
        *      자식클래스에서 중요하게 사용하고 있는 부모의 메소드를 수정 할 시
        *      자식클래스에 모두 영향을 미칠 수 있다.
        *   3. 부모클래스에서는 의미있는 기능이 자식에겐 무의미할 수 있다.
        * */
...
//        fireCar.isRunning();
        ...
        /* index 3. FireCar 가 너무 재미없게 경적을 울린다..그리고 물뿌리는 기능도 있으면 좋지 않을까? */
