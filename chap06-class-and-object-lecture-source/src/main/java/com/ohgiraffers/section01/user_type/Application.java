    ...
    * */
    ...
    String[] hobbies = new String[]{"야구","코딩","누워있기"};
        ...
        * */
        ...
        /* index 2-2. 생선 된 인스턴스(객체)의 초기값 확인 */
        /* comment.
        *   우리가 Member 클래스에 작성한 전역변수(필드)에 접근하기 위해서는
        *   레퍼런스변수명.변수명 <- 이 방법으로 접근 할 수 있다.
        *   '.' 은 참조연산자 라고 하는데, 레퍼런스 변수가 참조하고 있는 (주소를 가르키는)
        *   곳으로 접근한다 라는 의미이다.
        * */
        ...
        /* index 2-3. 필드(전역변수)에 접근해서 변수처럼 사용 */
        member.id = "user02";
        member.pwd = "pass02";
        member.name = "정은미";
        member.age = 30;
