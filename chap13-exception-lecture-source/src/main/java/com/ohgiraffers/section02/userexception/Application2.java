...
//            et.checkEnoughMoney(10000, 5000);
            ...
            /* title.
            *   주의사항!
            *   catch 블럭은 위에서 아래로 자신의 타입과 맞는 경우
            *   동작을 하게 되는데, 상위타입(NegativeException)이
            *   catch 블럭 상단에 위치하게 된다면 하단에 작성한
            *   하위타입(MoneyNegativeException)은 절대
            *   도달할 수 없는 코드가 되기 때문에 컴파일 에러를 발생시킨다. */
        ...
        // 예외 상황 별 catch 블럭을 따로 작성해서 처리할 수 있다.
            ...
            /* comment. finally 구문은 나중에 다시 다루겠지만, 사용한 자원을 닫는 곳에 많이 쓴다.*/
