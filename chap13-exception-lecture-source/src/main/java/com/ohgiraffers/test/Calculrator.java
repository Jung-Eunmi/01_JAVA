...
import com.ohgiraffers.test.exception.DivideNotZeroException;
import com.ohgiraffers.test.exception.MultipleNotZeroException;
...
public class Calculrator {
    ...
    public void multiplication(int num1 , int num2) throws MultipleNotZeroException {
        if(num1==0 || num2==0){
    ...
    public void division(int num1 , int num2) throws DivideNotZeroException {
        if(num1==0 || num2==0){
            throw new DivideNotZeroException("나누는 수는 0이 될 수 없습니다.");
        }else {
            System.out.println(num1 + "/" + num2 + "=" + (num1/num2));
        }
    }
