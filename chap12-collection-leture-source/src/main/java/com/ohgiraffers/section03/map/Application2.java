...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        *   사용하는 예시는 대부분 설정 관련 파일의 값을 읽어 어플리케이션에 적용하기 위해 사용한다.
        * */

        // Properties 는 값의 의미를 가졌다.
        // <> 제네릭을 안쓰는 이유는 String 으로 고정되있다.
        ...
        /* index 1. OutPut 으로 파일을 내보냈다. 이제 내보낸 파일을 읽어보자 */
        Properties prop2 = new Properties();

        try {
            prop2.load(new FileInputStream("driver.dat")); //Input : 가져오기
            prop2.load(new FileReader("driver.txt")); //Reader : 읽다
