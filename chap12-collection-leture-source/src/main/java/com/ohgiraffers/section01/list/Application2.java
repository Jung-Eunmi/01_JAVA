...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        /* comment.
        *   LinkedList
        *   Array 가 배열을 이용해서 발생할 수 있는 성능적인 단점을
        *   보완하고자 나온 클래스이다.
        ...
        * */
        ...
        /* comment.
        *   단일 연결 리스트
        *   저장한 요소가 순서를 유지하지 않고 저장되지만,
        *   이러한 요소들 사이를 링크로 연결하여 구성하며
        *   마치 연결 된 리스트 형태인 것 처럼 만든 자료 구조이다.
