...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        *   프로그램 외부에서 데이터를 가져와 사용해야 할 경우도 존재한다.
        ...
        *   스트림은 단방향이다.
        *   즉 데이터를 읽어오기 위한 통로는 입력 스트림, 데이터를 내보내기 위한 통로는 출력 스트림
        ...
        * */
        ...
        try {
            ...
            // read() : 파일에 기록 된 값을 순차적으로 읽어오고, 더 이상 읽을 데이터가 없으면 -1 값을 반환
            int value;

            // 한글 1 글자는 3byte 이기 때문에 1byte 씩 읽어오면 글자가 깨지게 된다.
