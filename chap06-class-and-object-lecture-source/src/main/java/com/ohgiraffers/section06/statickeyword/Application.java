...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        *   static 키워드의 남발은 유지보수와 추적이 힘든 코드를 작성하는 피해야 할 방식이다.
        ...
        * */
        ...
        System.out.println("증가시킨 후 nonStatic 필드 값 : " + sft1.getNonStaticCount());
        System.out.println("증가시킨 후 Static 필드 값 : " + sft1.getStaticCount());
        ...
        System.out.println("Static 필드 값 : " + sft2.getStaticCount()); // new라는 키워드에 영향을 받지 않는다.

        /* comment.
        *   인스턴스 변수의 경우에는 sft1 과 sft2 두 개의 인스턴스가 서로 값을 공유하지 못 한다.
