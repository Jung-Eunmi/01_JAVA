...
public class Application3 {
    ...
    public static void main(String[] args) {
        ...
        /* comment.
        *   깊은 복사란?
        *   heap 에 생성된 배열이 가지고 있는 값을 또 다른 배열에 복사를 해 둔 것이다.
        *   서로 같은 값을 가지고 있지만, 두 배열은 서로 다른 배열이기 때문에
        *   원본 또는 복제본을 수정하더라도 서로 영향을 미치지 않는다.
        * */
        ...
        * */
        ...
        /* index 3. System 의 arraycopy() 를 이용한 값 복사 */
        ...
        *   5. 복사할 길이 */
        ...
        /* index 4. Arrays 의 copyOf() 메소드를 이용한 복사 (이것만 기억해도 됨) */

        /* 전달인자
        *   1. 복사하고 싶은 배열(originArr)
        *   2. 만들고 싶은 배열의 길이 */
