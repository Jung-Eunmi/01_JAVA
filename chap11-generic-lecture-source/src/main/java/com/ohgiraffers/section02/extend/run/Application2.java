...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        /* comment.
        *   Bunny 이거나 Bunny 의 후손 토끼 농장만 매개변수로 사용이 가능하고,
        *   상위 타입인 Rabbit 은 매개변수로 사용이 불가능하다. */
//        wildCardFarm.extendsType(new RabbitFarm<>(new Rabbit()));
        ...
        /* comment.
        *   Bunny 이거나 Bunny 의 부모 토끼 농장만 매개변수로 사용이 가능하고,
        *   하위 타입인 DrunkenBunny 은 매개변수로 사용이 불가능하다 */
