...
public class Application4 {
    ...
    public static void main(String[] args) {
        ...
        /* title. 배열의 깊은 복사를 사용한 java 문법을 이해하고 활용하기. */

        /* comment.
        *   깊은 복사는 원본 배열과 복사본 배열 둘 중 한 가지의 값을 변경하더라도 전혀 영향을 주지 않는다.
        *   why? -> 다른 주소를 가지고 있기 때문이다.
        *   같은 값을 가지고 있는 서로 다른 배열이다.
        * */
        ...
        /* index 2. 각 배열의 인덱스에 10씩 누적 증가하기 */
        ...
        * */
        ...
        for (int i : arr2) {
            i += 10; // 연산이 되지 않는다.(=값이 변경되지않는다) 단순 값을 확인할때만 사용한다.
        }
        ...
        /* comment.
        *   주의
        *   - 향상 된 for 문은 배열의 인덱스에 차례로 접근 할 때는 유용하나,
        *   - 값을 변경할 수는 없다.
        * */
        for (int i : arr2) {
            System.out.print(i + " ");
