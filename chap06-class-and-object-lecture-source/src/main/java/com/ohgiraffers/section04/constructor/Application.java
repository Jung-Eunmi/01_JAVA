...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        /* comment.
        *   생성자란?
        *   우리가 지금까지 클래스명 래퍼런스변수명 = new 클래스명(); 이렇게 객체를 만들어왔다.
        ...
        *   주의점!!!
        *   만약 매개변수가 있는 생성자가 존재한다면 기본 생성자는 컴파일러가 자동으로 추가해주지 않는다.
        *   따라서 이 점을 주의해야한다.
        * */

        UserDTO user2 = new UserDTO("user02","pass02","정은미");
        System.out.println("user2 의 초기값 : " + user2.toString());

        UserDTO user3 = new UserDTO("user03","pass03","정은미", LocalDateTime.now());
